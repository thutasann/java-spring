...
public class ProductController {
    ...
    @GetMapping("/test/{id}")
    public ResponseEntity<String> sleep5s(@PathVariable Long id) throws InterruptedException {
        Thread.sleep(5000);
    ...
    public ResponseEntity<ApiResponse> getProductsByBrandAndName(@RequestParam String brandName,
        ...
        try {
            ...
            if (products.isEmpty()) {
                return ResponseEntity.status(NOT_FOUND).body(new ApiResponse("No products NotFound", null));
            }
            List<ProductDto> convertedProducts = productService.getConvertedProducts(products);
